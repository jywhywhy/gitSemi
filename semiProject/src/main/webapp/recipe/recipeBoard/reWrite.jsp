...
<body>
<form id="form" name="form" method="post" action="${path}/recipeBoard_servlet/reWrite.do" enctype="multipart/form-data">
 ...
 <div class="container" align="center">
  <div class="border border-3 write_div" style="border-radius: 20px; background-color: rgba(255,255,255,0.9);">
   <h2 class="mt-3 mb-5 h2" style="font-weight: bold;">답글 작성</h2>
