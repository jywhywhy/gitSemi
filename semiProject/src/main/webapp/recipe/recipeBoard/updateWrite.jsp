...
<body>
<form id="form" name="form" method="post" action="${path}/recipeBoard_servlet/update.do" enctype="multipart/form-data">
 ...
 <div class="container" align="center">
  <div class="border border-3 write_div" style="border-radius: 20px; background-color: rgba(255,255,255,0.9);">
   <h2 class="mt-3 mb-5 h2" style="font-weight: bold;">글 수정</h2>
   <div class="container" align="left">
    <label for="subject" class="form-label" style="font-weight: bold;">&nbsp;제목</label>
    <input class="form-control input" name="subject" id="subject" value="${param.subject}">
    <label for="content" class="form-label mt-1" style="font-weight: bold;">&nbsp;내용</label>
    <textarea rows="10" class="form-control input mb-3" name="content" id="content" style="resize: none;">${param.content}</textarea>
