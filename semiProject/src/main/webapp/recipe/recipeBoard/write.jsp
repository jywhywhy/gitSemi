...
<body>
<form method="post" id="form" name="form" action="${path}/recipeBoard_servlet/write.do" enctype="multipart/form-data">
 <div class="container" align="center">
  <div class="border border-3 write_div" style=" border-radius: 20px; background-color: rgba(255,255,255,0.9);">
   <h2 class="mt-3 mb-5 h2" style="font-weight: bold;">글쓰기</h2>
